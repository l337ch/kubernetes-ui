    ...
    .config([
      ...
      function($routeProvider, manifestProvider) {
        ...
        var _extractPageValues = function(page) {
          _routes.push({url: page.url, templateUrl: page.templateUrl, controller: page.controller, css: page.css});
        };
          ...
          if (section.children) {
            section.children.forEach(function(childSection) {
              if (childSection.pages) {
                childSection.pages.forEach(function(page) { _extractPageValues(page); });
              }
            });
          } else if (section.pages) {
            section.pages.forEach(function(page) { _extractPageValues(page); });
